...
(custom-set-variables
 ...
 '(org-agenda-files
   (quote
    ("~/Sandbox/TODO.org" "~/Ubuntu One/OrgMode/health.org" "/home/fakedrake/.orgmode/agenda/notes.org")))
 '(safe-local-variable-values
   (quote
    ((c-default-style . "linux")
     (cs-key "tsi-driver")
     (fd-setup-test-cmd . "test")
     (fd-setup-test-cmd . "nosetests")
     ...
     (eval progn
	   ...
	   (c-set-offset
	    (quote inline-open)
	    (quote 0)))
     (gtags-path-style quote root)
     (gtags-rootdir . "/homes/cperivol/Projects/Nema/ZYNQ/linux-zynq/")
     (gtags-rootdir . "~/Projects/linux-3.7-rc8/")
